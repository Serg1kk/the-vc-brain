...
// 'inferred' is unaffected by what is or isn't in these lists -- see scoring.js tierForDomain).
//
// Conventions (binding for lib/f04/):
//   * This is the ONLY file allowed to hold a magic number/threshold/weight/domain list.
//     scoring.js imports everything it needs from here -- no literal duplication.
...
// breakpoint in §6.2's tam_low table (300M/1B, 600M/2B, 1.5B/5B) -- see the
// worked-example note in scoring.js above ventureScaleCheck for the §6.2
// internal contradiction this file deliberately does NOT reproduce.
