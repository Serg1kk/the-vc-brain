...
def build_contradiction_scan():
    ...
    llm_js = (
        ...
        "    candidate: { sourceUrl: pair.evidence.source_url || null, quote: primary.found_reality, tier: effectiveTier },\n"
        ...
        "  if (gate.resolved) {\n"
        "    const evidenceRow = await buildEvidenceRow({\n"
        "      claimId: pair.claim_id, relation: 'contradicts', tier: effectiveTier, quoteVerbatim: primary.found_reality,\n"
        "      sourceUrl: pair.evidence.source_url || null, rawSignalId: pair.evidence.raw_signal_id,\n"
        "      checkId: 'contradiction_llm', candidateKey: primary.found_reality,\n"
        "    });\n"
